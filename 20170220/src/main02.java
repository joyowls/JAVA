...
public class main02 {
	...
	public static void main(String[] args) {
		...
		//1)char 문자를 표현하기위한 자료형 크기 : 2byte
		//문자는 작은 따옴표를 활용한다.
		...
		//정수를 표현 할 때는 항상  int로 변수를 선언하는 것 이 좋다.
		//*byte는 자료를 모을 때나 최소 자료형으로 자료들을 분할 할 때 사용된다.
		
		int num = 100;
		//int num2 = 100.23; 실수 자료를 정수형 변수에 대입 할 수 없다.
		...
		char ch2 = 'A'+1;		//2byte
		int i2 = ch2;		//4byte 작은 공강에 있던 데이터는 큰 공간의 데이터 변수로 옮겨 질 수 있다.
							//자동 형변환(묵시적, 암시적 형변환)
		System.out.println(ch2);
		System.out.println(i2);
		
		double d2 = 10.15; 		//8byte
